...
class PublicUserApiTests(TestCase):
    ...
    def test_create_user_success(self):
        ...
        self.assertNotIn('password', res.data) # just confirms that we didn't recieved the actual password
    ...
    def test_password_too_short_error(self):
        ...
        # checks whether it created the user with short password
...
class PrivateUserApiTest(TestCase):
    ...
    def test_pos_me_not_allowed(self):
